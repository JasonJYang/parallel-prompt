...
def save_generated_data_to_csv(filename, save_dir="generated"):
    ...
    with open(save_dir, 'w', newline='', encoding='utf-8') as csv_file:
        csv_writer = csv.writer(csv_file)

        # Write the header row
        csv_writer.writerow(['Original Data', 'Generated'])
